...
check_feature "admin.html" "Exclude hidden events from campaign picker" "Campaign date-range picker excludes hidden events (published === false)"
check_feature "admin.html" "openCampaignBuilder" "Campaign builder refreshes events before opening (Create + Edit)"
